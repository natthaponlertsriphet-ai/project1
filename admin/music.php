...
// Handle Gallery Photo Delete (Separated: strictly applies to /images/live-music/)
if (isset($_GET['action']) && $_GET['action'] === 'delete_photo' && isset($_GET['filename'])) {
    ...
    if (file_exists($photo_path_live) && @unlink($photo_path_live)) {
...
// Handle Photo Upload (Separated: strictly uploads to /images/live-music/)
