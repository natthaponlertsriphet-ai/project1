...
<div class="flex justify-between items-center border-b border-zinc-800 pb-4 mb-6">
    <div>
        <h1 class="font-anton text-amber-400 text-uppercase tracking-wider text-2xl m-0 flex items-center gap-2.5">
            <span class="material-symbols-outlined text-amber-400 text-2xl leading-none">sports_bar</span>
            <span><?php echo t("Draft Beer Manager", "จัดการข้อมูลรายการเครื่องดื่ม"); ?></span>
        </h1>
        <p class="text-zinc-300 text-xs mt-1 uppercase tracking-widest font-mono"><?php echo t("Admin Dashboard / Live Beer Control", "แผงควบคุมผู้ดูแลระบบ / จัดการเบียร์สดหน้าร้าน"); ?></p>
    </div>
</div>
