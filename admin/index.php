                            ...
                            <td class="text-center">
                                <div class="flex justify-center gap-2">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php elseif ($active_tab === 'confirmed'): ?>
                                            <span class="badge bg-emerald-950 text-emerald-400 border border-emerald-900/60 px-2.5 py-1 text-xs rounded me-2"><?php echo t("Approved", "อนุมัติแล้ว"); ?></span>
                                            <a href="index.php?action=clear_table&booking_id=<?php echo $b['id']; ?>" class="shadcn-btn-success py-1.5 px-3 text-xs uppercase font-anton tracking-wider me-2" onclick="return confirm('<?php echo t('Clear this table for new bookings?', 'คุณแน่ใจว่าต้องการเคลียร์โต๊ะนี้เพื่อรับลูกค้ากลุ่มใหม่?'); ?>')"><?php echo t("Clear Table", "เคลียร์โต๊ะ"); ?></a>
                                        ...
                                        <?php elseif ($active_tab === 'completed'): ?>
                                            <span class="badge bg-zinc-950 text-zinc-400 border border-zinc-900 px-2.5 py-1 text-xs rounded me-2"><?php echo t("Completed", "ใช้งานเสร็จแล้ว"); ?></span>
                                        <?php elseif ($active_tab === 'cancel_requests'): ?>
                                            <a href="index.php?action=approve_cancel&booking_id=<?php echo $b['id']; ?>&tab=cancel_requests" class="shadcn-btn-danger py-1.5 px-3 text-xs uppercase font-anton tracking-wider" onclick="return confirm('<?php echo t('Are you sure you want to approve this cancellation request?', 'คุณแน่ใจว่าต้องการยืนยันการยกเลิกการจองนี้?'); ?>')"><?php echo t("Approve Cancel", "ยืนยันยกเลิก"); ?></a>
