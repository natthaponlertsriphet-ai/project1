...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `table_id` | รหัสโต๊ะ | Varchar(50) | 50 | x(50) | A-Z,0-9,a-z,- | N | PK | - |
| `table_number` | หมายเลขโต๊ะ | Varchar(50) | 50 | x(50) | A-Z,0-9,a-z | Y | - | - |
| `zone` | โซนที่ตั้งโต๊ะ | Varchar(50) | 50 | x(50) | OUTDOOR, INDOOR_WINDOW, INDOOR_CENTER, STAGE, BAR, WALKWAY | N | - | - |
| `capacity` | จำนวนที่นั่งสูงสุด | Int | 11 | 9(11) | 0-9 | Y | - | - |
| `table_status` | สถานะโต๊ะ | Varchar(50) | 50 | x(50) | AVAILABLE, OCCUPIED | N | - | - |
...
| table_id | table_number | zone | capacity | table_status | image |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
หมายเหตุ: table_status AVAILABLE=ว่าง (เปิดบริการ), OCCUPIED=ไม่ว่าง (ปิดบริการหรือจองเต็มแล้ว)
